...
const DonationDetailspage = async ({ params }) => {
    ...
    return (
        <div className="min-h-screen  md:p-5 lg:p-10 bg-slate-50/50 dark:bg-slate-950   container mx-auto mt-15">
            ...
            <Card className="mx-auto mt-5 rounded-[32px] relative  overflow-hidden border border-slate-200 bg-white p-8 shadow-sm">
