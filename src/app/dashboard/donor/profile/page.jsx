...
const ProfileDonorpage = async () => {
    ...
    return (
        <div className='min-h-screen bg-white/10 py-21 md:py-6'>
            <section className="bg-gradient-to-r max-w-7xl  mx-auto from-[#db0000]/20 to-red-50 text-white py-12 px-6 sm:px-8 lg:px-10 rounded-2xl    shadow-sm">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-[1rem] md:text-sm text-slate-500 mt-1 dark:text-gray-300">View and update your personal information and account details.</p>
                    </div>
