                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[280px] md:auto-rows-[300px]">
                        ...
                        <div className="relative md:col-span-2 row-span-1 bg-white border border-slate-200/60 shadow-[0_2px_8px_-3px_rgba(0,0,0,0.05)] rounded-[2.5rem] p-8 flex flex-col justify-between overflow-hidden group">
                            ...
                            <div className="absolute bottom-0 right-0 bg-slate-50 pl-4 pt-4 rounded-tl-[2rem] border-t border-l border-slate-100 ">
                                <Link href={'/searchdonor'} className=''>
                                    <button className="bg-white hover:cursor-pointer border border-slate-200 hover:border-[#E11D48] text-slate-900 hover:text-[#E11D48] text-xs font-bold px-6 py-3.5 rounded-[1.5rem] flex items-center gap-2 transition-all duration-300 shadow-sm">
                        ...
                        <div className="relative md:col-span-2 row-span-1 bg-white border border-slate-200/60 shadow-[0_2px_8px_-3px_rgba(0,0,0,0.05)] rounded-[2.5rem] p-8 flex flex-col md:flex-row items-center gap-8 overflow-hidden">
                            ...
                            <motion.div
                                ...
                                className="relative flex-shrink-0 w-32 h-32 rounded-full border-4 border-slate-50 bg-slate-50/50 flex items-center justify-center p-2"
                            >
                            ...
                            <div className="space-y-2 flex-1 text-center md:text-left pb-16 md:pb-0">
                                ...
                                <h3 className="text-xl font-bold text-slate-900 tracking-tight">Explore Blood Requests</h3>
                            ...
                            <div className="absolute bottom-0 right-0 bg-slate-50 pl-4 pt-4 rounded-tl-[2rem] border-t border-l border-slate-100">
                                <Link href={'/donationrequest'}>
                                    <button className="bg-white border border-slate-200 hover:border-rose-400 text-slate-700 text-xs font-bold px-5 py-3 rounded-[1.25rem] hover:text-rose-400 transition-all duration-300 shadow-sm hover:cursor-pointer">
                                        View Request
                                    </button>
                                </Link>
                            </div>
