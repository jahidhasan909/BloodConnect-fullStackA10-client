...
const MyDonationRequestPeginationVolunteer = ({ donationRequest, user }) => {
    ...
    return (
        <div className='bg-white/10'>
            ...
            <div className="py-17  px-2 lg:py-10 max-w-11/12 mx-auto space-y-6 md:space-y-8 min-h-screen pb-20  relative">

                <header className="py-13 px-10 rounded-2xl bg-gradient-to-r from-[#db0000]/20 to-red-50 border border-red-100   flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs lg:text-[1rem] text-slate-500 mt-1">View and manage all your blood donation requests.</p>
                    </div>
...
export default MyDonationRequestPeginationVolunteer;